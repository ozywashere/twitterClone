...
export default function More() {
  return (
    <Popover className='relative'>
      <Popover.Button className='py-0.5 block group'>
        <div className='p-3 rounded-full transition-colors inline-flex  items-center  group-hover:bg-[#eff3f41a] focus:border-none'>
          <div className='w-[1.641rem] h-[1.641rem] relative'>
            <svg viewBox='0 0 24 24' className='h-[1.641rem] mr-6'>
              <path
                fill='currentColor'
          ...
          <div className='text-xl ml-5 mr-4 leading-6 text-[#e7e9ea]'>More</div>
        </div>
      </Popover.Button>
      <Popover.Panel className='w-[318px] absolute bottom-0 left-0 bg-black shadow-box rounded-xl overflow-hidden z-10'>
        <button className='p-4 h-14 w-full transition-colors inline-flex items-center'>
          <div className='w-[1.641rem] h-[1.641rem] relative mr-6'>
          ...
          <div className='text-xl leading-6 font-bold'>Connect</div>
        </button>
        <button className='p-4 h-14 w-full transition-colors inline-flex items-center '>
          <div className='w-[1.641rem] h-[1.641rem] relative mr-6'>
            <svg viewBox='0 0 24 24' aria-hidden='true' fill='#e7e9ea' data-testid='icon'>
              <path
                fill='currentColor'
          ...
          <div className='text-xl leading-6 font-bold'>Monetization</div>
        </button>
        <Disclosure>
          {({ open }) => (
            <>
              <Disclosure.Button className='flex items-center justify-between w-full p-4 font-bold hover:bg-[#16181c] transition-colors'>
                Creator Studio
                <svg
              ...
              <Disclosure.Panel>
                <Link to='/' className='flex items-center px-3 h-11 gap-3 font-medium hover:bg-[#2f3336] transition-colors'>
        ...
        <Disclosure>
          {({ open }) => (
            <>
              ...
              <Disclosure.Panel>
                <Link to='/' className='flex items-center px-3 h-11 gap-3 font-medium hover:bg-[#16181c] transition-colors'>
                  <svg viewBox='0 0 24 24' className='h-[1.172rem] ' fill='#e7e9ea'>
